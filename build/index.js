...
// Register the tool
server.tool("speechToText", "Convert base64 audio into text using OpenAI Whisper", speechToTextShape, async ({ input }) => {
    const { audioBase64, filetype } = input;
